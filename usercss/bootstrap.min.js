...
(function() {
    ...
    <header class="smart-header">
        <div class="container d-flex justify-content-between align-items-center" style="height: 72px;">
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" id="knowledgeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Knowledge Bank</a>
                            <ul class="dropdown-menu" aria-labelledby="knowledgeDropdown">
                                <li><a href="${rootPrefix}resources/Calculators/GST_CALCULATOR/GST_CALCULATOR.html" class="dropdown-item">Calculators</a></li>
                                <li><a href="${rootPrefix}resources/Utilities/Rates_of_TDS/Rates_of_TDS.html" class="dropdown-item">Utilities & TDS Rates</a></li>
                                <li><a href="${rootPrefix}resources/Links/Quick_Link/Quick_Link.html" class="dropdown-item">Quick Links</a></li>
                                <li><a href="${rootPrefix}laws/-26/Income_Tax_Act.html" class="dropdown-item">Direct Tax & Indirect Tax Acts</a></li>
                                <li><a href="${rootPrefix}resources/Forms/Income_Tax_Forms/Income_Tax_Forms.html" class="dropdown-item">Tax Forms</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a href="${rootPrefix}NewThemeQuerysheet.html" class="nav-link">Query</a></li>
                        <li class="nav-item"><a href="${rootPrefix}resource/Career.html" class="nav-link">Careers</a></li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" id="adminDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Admin</a>
                            <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                                <li><a href="${rootPrefix}Login.html" class="dropdown-item">Login</a></li>
                                <li><a href="http://mail.knmcassociates.com/" target="_blank" class="dropdown-item">Email Login</a></li>
                                <li><a href="${rootPrefix}Timesheet.html" class="dropdown-item">Time Sheet</a></li>
                            </ul>
                        </li>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (bodyForm) {
            const legacyHeader = document.querySelector('#HeaderControl') || document.querySelector('.rdTable');
            const legacyNav = document.querySelector('#MenuControl');
            if (legacyHeader) legacyHeader.remove();
            if (legacyNav) legacyNav.remove();

            let pageContent = document.querySelector('#HomepagecontentControl_C') || 
                              document.querySelector('#tbl_forcss1') || 
                              document.querySelector('.innr-pg-c') ||
                              document.querySelector('.main-table');

            if (pageContent) {
                const mainShell = document.createElement('main');
                mainShell.className = 'container py-5';
                
                const contentRow = document.createElement('div');
                contentRow.className = 'row justify-content-center';
                
                const contentCol = document.createElement('div');
                contentCol.className = 'col-lg-10 col-12';
                
                while (pageContent.firstChild) {
                    contentCol.appendChild(pageContent.firstChild);
                }
        ...
        document.querySelectorAll('table').forEach(tbl => {
            tbl.classList.add('table', 'table-responsive', 'table-hover');
        });
