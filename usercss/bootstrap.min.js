...
(function() {
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown mega-dropdown">
                            <a href="${rootPrefix}resource/Knowledge_Bank.html" class="nav-link dropdown-toggle" id="knowledgeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Knowledge Bank</a>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const isKB = pathLower.includes('/resources/') || 
                     pathLower.includes('/laws/') || 
                     pathLower.includes('/notificationsearch/') || 
                     pathLower.includes('/advancesearch/');

        if (isKB) {
            // Decoupled loading structure: pull dedicated Knowledge Bank modules sequentially
            const scriptPaths = [
                'userjs/knowledge-navigation.js',
                'userjs/knowledge-search.js',
                'userjs/knowledge-bank.js'
            ];
            ...
            const loadScriptSequentially = (index) => {
                ...
                s.src = rootPrefix + scriptPaths[index];
                s.async = false;
                s.onload = () => {
            ...
            // General pages fallback logic: inject unified sticky header & footer only
            if (isRewritten) {
                // Rewritten pages already have custom static structures
            } else {
                // Inject modern header
                ...
                // Make standard tables responsive
