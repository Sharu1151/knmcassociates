...
// Global CA Website Redesign Injector
(function() {
    "use strict";

    if (window.__ca_redesign_run) {
        return;
    }
    window.__ca_redesign_run = true;

    // Global UMD environment patch for legacy Telerik pages:
    // Temporarily clear global CommonJS variables during document loading/parsing
    // to prevent CDN scripts from executing CommonJS branches and failing to register globally.
    const _temp_module = window.module;
    const _temp_exports = window.exports;
    window.module = undefined;
    window.exports = undefined;

    // Intercept $create definitions globally to handle missing elements gracefully
    (function() {
        let originalCreate = window.$create;
        const patchCreate = (fn) => {
            if (!fn || fn.__isPatched) return fn;
            const patched = function(type, properties, events, references, element) {
                ...
                try {
                    ...
                    console.warn("Suppressed Telerik $create error on missing element:", e);
                    return null;
                }
            };
        ...
        if (originalCreate) {
            window.$create = patchCreate(originalCreate);
        }
        
        Object.defineProperty(window, '$create', {
            get: () => originalCreate,
            set: (val) => {
                originalCreate = typeof val === 'function' ? patchCreate(val) : val;
            },
            configurable: true,
            enumerable: true
        });
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (typeof _temp_module !== 'undefined') window.module = _temp_module;
        if (typeof _temp_exports !== 'undefined') window.exports = _temp_exports;
    });

    // Synchronously inject missing dependencies for calculators
    const pathLower = window.location.pathname.toLowerCase();
    if (pathLower.includes('/calculators/') || pathLower.includes('/utilities/')) {
        let rootPrefix = '';
        ...
        document.write('<link rel="stylesheet" href="https://code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">');
        document.write('<link rel="stylesheet" href="' + rootPrefix + 'usercss/calc_style.css">');
        ...
        document.write('<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-numeric/1.4.1/jquery.numeric.min.js"></script>');
    }

    // Check if the page is already rewritten manually
    ...
    const computeRootPrefix = () => {
        const scriptTag = Array.from(document.querySelectorAll('script')).find(
            s => s.src && s.src.includes('usercss/bootstrap.min.js')
        );
        if (scriptTag) {
    ...
    if (isKnowledgeBankPage() && !document.querySelector('link[href*="knowledge-bank.css"]')) {
        ...
        kbCss.href = kbRoot + 'usercss/knowledge-bank.css';
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown mega-dropdown">
                            <a href="${rootPrefix}knowledge-bank.html" class="nav-link dropdown-toggle" id="knowledgeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Knowledge Bank</a>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-12">
                                        ...
                                        <ul class="list-unstyled mega-menu-list">
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=quick-links" class="dropdown-item">Quick Links</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=important-links" class="dropdown-item">Important Links</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=vat-links" class="dropdown-item">GST/VAT Links</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=ease-links" class="dropdown-item">Ease Of Doing Business</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <h6 class="mega-menu-title"><i class="fa fa-book me-2 text-primary"></i>Acts</h6>
                                        <ul class="list-unstyled mega-menu-list mb-0">
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=direct-tax" class="dropdown-item">Direct Tax</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=indirect-tax" class="dropdown-item">Indirect Tax</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=corporate-laws" class="dropdown-item">Corporate Laws</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=vat-laws" class="dropdown-item">VAT Laws</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=other-statutes" class="dropdown-item">Other Statutes</a></li>
                                            <li><a href="${rootPrefix}knowledge-bank.html?cat=gst-laws" class="dropdown-item">GST Laws</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (bodyForm) {
            ...
            if (pageContent) {
                ...
                let categoryUrl = "Knowledge_Bank.html";
                const pathLower = window.location.pathname.toLowerCase();
        ...
        if (isKnowledgeBankPage()) {
            ...
            loadKbScript('userjs/knowledge-bank.js', () => {
