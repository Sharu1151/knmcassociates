...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (bodyForm) {
            ...
            if (pageContent) {
                // Formatting Telerik underscores in header titles
                ...
                if (headText) {
                    headText.innerHTML = headText.innerHTML.replace(/_/g, ' ').trim();
                    headText.className = 'main-heading text-center d-block mb-4';
                    headText.style.fontSize = '2.2rem';
                    headText.style.fontWeight = '800';
                    headText.style.color = 'var(--primary-color)';
                    headText.style.textDecoration = 'none';
                }
